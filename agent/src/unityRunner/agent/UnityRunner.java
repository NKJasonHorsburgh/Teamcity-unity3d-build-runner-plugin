...
public class UnityRunner {
    ...
    List<String> getArgs() {
        ...
        String extraArgs[] = translateCommandline(configuration.extraOpts);
    ...
    /// shamelessly stolen from https://commons.apache.org/proper/commons-exec/apidocs/src-html/org/apache/commons/exec/CommandLine.html
    /**
